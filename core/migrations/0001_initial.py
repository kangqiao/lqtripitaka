# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-06-15 18:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='page_next_page', to='core.Page', verbose_name='下一页')),
                ('pre_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='page_pre_page', to='core.Page', verbose_name='上一页')),
            ],
            options={
                'verbose_name': '页',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qianziwen', models.CharField(blank=True, max_length=8, verbose_name='千字文')),
                ('remark', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('end_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='roll_end_page', to='core.Page', verbose_name='终止页')),
            ],
            options={
                'verbose_name': '卷',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dynasty', models.CharField(blank=True, max_length=64, verbose_name='朝代')),
                ('historic_site', models.CharField(blank=True, max_length=64, verbose_name='刻经地点')),
                ...
                ('publish_name', models.CharField(blank=True, max_length=64, verbose_name='出版社')),
                ...
                ('publish_ISBN', models.CharField(blank=True, max_length=64, verbose_name='ISBN')),
                ('remark', models.TextField(blank=True, null=True, verbose_name='备注')),
            ],
            options={
                'verbose_name': '藏经版本',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name2', models.CharField(blank=True, max_length=64, verbose_name='经号')),
                ('type', models.CharField(choices=[('ST', '经'), ('RT', '律'), ('TT', '论')], default='ST', max_length=2, verbose_name='类型')),
                ('clazz', models.CharField(blank=True, max_length=64, verbose_name='部别')),
                ('dynasty', models.CharField(blank=True, max_length=64, verbose_name='朝代')),
                ('historic_site', models.CharField(blank=True, max_length=64, verbose_name='刻经地点')),
                ('roll_count', models.IntegerField(verbose_name='卷数')),
                ('qianziwen', models.CharField(blank=True, max_length=8, verbose_name='千字文')),
                ('remark', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('end_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sutra_end_page', to='core.Page', verbose_name='终止页')),
                ...
                ('start_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sutra_start_page', to='core.Page', verbose_name='起始页')),
            ],
            options={
                'verbose_name': '经',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nameA', models.CharField(blank=True, max_length=64, verbose_name='名字A')),
                ('nameB', models.CharField(blank=True, max_length=64, verbose_name='名字B')),
                ('remark', models.TextField(blank=True, null=True, verbose_name='备注')),
            ],
            options={
                'verbose_name': '作译者',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('end_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='volume_end_page', to='core.Page', verbose_name='终止页')),
                ('series', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.Series', verbose_name='版本')),
                ('start_page', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='volume_start_page', to='core.Page', verbose_name='起始页')),
            ],
            options={
                'verbose_name': '册',
        ...
        migrations.AddField(
            model_name='sutra',
            name='translator',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='core.Translator', verbose_name='作译者'),
        ),
        migrations.AddField(
            model_name='roll',
            name='series',
        ...
        migrations.AddField(
            model_name='roll',
            name='start_page',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='roll_start_page', to='core.Page', verbose_name='起始页'),
        ),
        migrations.AddField(
            model_name='roll',
            name='sutra',
